...
#		self.playerName.append("User")       
	...
	#check if one player get all cards give point to others
			...
			if self.bidnumber==None  and self.bidsuite==None:
				...
				if self.turnBid==1:
					...
					if self.bid!=0:
						...
						self.playerspassedbid = 0
						print "%s bid %d, %s" % (self.player1.name, self.currentbidnumber, self.textsuite(self.currentbidsuite),)
					else:
					...
					if self.bid!=0:
						...
						self.playerspassedbid = 0
						print "%s bid %d, %s" % (self.player2.name, self.currentbidnumber, self.textsuite(self.currentbidsuite),)
					else:
					...
					if self.bid!=0:
						...
						self.playerspassedbid = 0
						print "%s bid %d, %s" % (self.player3.name, self.currentbidnumber, self.textsuite(self.currentbidsuite),)
					else:
			...
			if self.turnPlay==1 and self.player1.currentPlay==None:
				...
				print "Player 1 plays ", self.textcardnumber(self.selectedCard.name), " of ", self.textsuite(self.selectedCard.type)
				...
				print "Player 2 plays ", self.textcardnumber(self.selectedCard.name), " of ", self.textsuite(self.selectedCard.type)
				self.selectedCard=None
				...
				print "Player 3 plays ", self.textcardnumber(self.selectedCard.name), " of ", self.textsuite(self.selectedCard.type)
				self.selectedCard=None
...
#						numOfMaxPlayed=self.tmpPlayedCard[i][0].name
	...
	def introDialog(self):
		...
		textAbout = font.render("1.The point is to make your bid or stop other bids", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,25)) 
		textAbout = font.render("2.Bid the number of points you can obtain;", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,40)) 
		textAbout = font.render("   point cards are 10 through Ace", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,55))
		textAbout = font.render("3.The cards go A(sp), J(trump), J(color of trump),", 1, (0, 0, 0))
		...
		textAbout = font.render("   highest card that follows suite", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,100))
		textAbout = font.render("5.The points of the person with the General card", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,115))
		textAbout = font.render("   are added to those of the Napoleon, the bid winner", 1, (0, 0, 0))
		...
		textAbout = font.render("5.Computer players are very stupid", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,160)) 
		textAbout = font.render("   but no longer think they are playing hearts.", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,175)) 
		textAbout = font.render("6.Many thanks to python, pyGames, pyHearts", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,190)) 
		textAbout = font.render(" and Milad Rastian without which/whom this might", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,205)) 
		textAbout = font.render(" never have been created", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,220)) 
		textAbout = font.render("as well as the NNHS crew, you know who you are", 1, (0, 0, 0))
		self.screen.blit(textAbout, (10,235)) 
